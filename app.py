...
app=Flask(__name__)
@app.route('/')  # add any name for home 
def home():
    return render_template('index.html')

@app.route('/home',methods=['GET'])
def root():  #OBJECT CLASSIFICATION PROGRAM FOR VIDEO IN IP ADDRESS
    
    url = 'http://192.168.158.62/cam-hi.jpg' # this Url from esp32cam using arduino ide
    ...
    net.setInputSize(320,320) #net.setInputSize(480,480)
